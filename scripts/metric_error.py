...
# Paths for chains
lsst_path    = '/home/grads/extra_data/evan/noise_chains/'
...
for i in range(start,stop):
    ...
    try:
        chain1 = getdist.mcsamples.loadMCSamples('/home/grads/data/evan/cosmopower_emcee/notebooks/planck_emulated',no_cache=True)#planck_path+str(i))
        chain2 = getdist.mcsamples.loadMCSamples(lsst_path+'noise_'+str(i),no_cache=True)
        ...
        chain2.removeBurnFraction(0.5) # forgot :(
        chain2.weighted_thin(50)       #forgot
    except:
